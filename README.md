# pmsctl
Herramienta para la gestion de BBDD replicadas con Oracle Standard Edition 2

Este proyecto ha sido desarrollado como parte del Trabajo de Fin de Estudio, 
